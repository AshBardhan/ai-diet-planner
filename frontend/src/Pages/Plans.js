...
export default function Plans(){
    return(
        <>
            <h1 style={{textAlign: 'center',fontSize:'48px',fontWeight: 'bold'}}>Shape your goals faster <br/> <span style={{color: '#bcbcbc'}}>Upgrade to PRO plan today</span></h1>
              ...
              <div style={{width: '400px', textAlign: 'center'}}>
                <Tile themes={['shadow']}>
                  <div style={{padding:'20px 0'}}>
                    ...
                    <h2 style={{fontSize: '54px', color:'#07b14a', fontWeight: 600}}>$0<sup style={{fontSize: '18px'}}>/mo</sup></h2>
                    ...
                    <Button size="super-big" label="Get Started" />
                  </div>
                </Tile>
              </div>
              <div style={{width: '400px', textAlign: 'center'}}>
                <Tile themes={['shadow']}>
                  <div style={{padding:'20px 0'}}>
                      ...
                      <h2 style={{fontSize: '54px', color:'#3892e3', fontWeight: 600}}>$30<sup style={{fontSize: '18px'}}>/mo</sup></h2>
                      <ul style={{listStyle: 'none', fontSize: '16px', marginBottom: '50px'}}>
                        <li style={{display: 'flex', alignItems: 'center',marginBottom:'20px'}}>
                          <span style={{flexShrink: 0, width: '30px', fontSize: '20px', fontWeight: 'bold', color: 'green'}}>&#x2713;</span>
                          <span>Generate daily meal plans</span>
                      ...
                      <Button theme="primary" size="super-big" isInverted="true" label="Upgrade to PRO Plan" />
                  </div>
                </Tile>
              </div>
            </div>
