...
export default function Home() {
	...
	const cards = [
		{
			key: 'Daily Nutrition',
			content: 'Proper nutrition planning can support athletic performance by providing the necessary nutrients for muscle growth, repair, and recovery.',
			photo: require('../Images/nutrition.jpeg'),
		},
		{
			key: 'More Meals',
			content: ' Splitting meals can also increase nutrient absorption and improve digestion by allowing the body to digest smaller portions more efficiently.',
			photo: require('../Images/split-meals.jpg'),
		},
		{
			key: 'Balanced Diet',
			content:
		...
		{
			key: 'Pre/Post Workout Snacks',
			content: 'A healthy diet and regular exercise can help maintain a healthy weight, reduce body fat, and boost the immune system, helping fight off infections and illnesses.',
			photo: require('../Images/workout.jpg'),
		},
	];

	const benefits = [
		{
			key: 'Create your own eating style',
			content: 'Proper nutrition planning can support athletic performance by providing the necessary nutrients for muscle growth, repair, and recovery.',
			photo: require('../Images/choices.png'),
		},
		{
			key: 'Reduce food waste',
			content: ' Splitting meals can also increase nutrient absorption and improve digestion by allowing the body to digest smaller portions more efficiently.',
			photo: require('../Images/waste.png'),
		},
		{
			key: 'Drop Anxiety of what to eat',
			content: 'Customized diet plans are tailored to an individuals unique nutritional needs, preferences, and goals, ensuring that they are receiving the right nutrients.',
			photo: require('../Images/anxiety.png'),
		},
		{
			key: 'Easy to cook recipies',
			content: 'A healthy diet and regular exercise can help maintain a healthy weight, reduce body fat, and boost the immune system, helping fight off infections and illnesses.',
			photo: require('../Images/recipe.png'),
		},
	];
	...
	return (
		<>
			...
			<div className="quick-tabs">
				<div className="container">
					<h2>
						Shaping your <span>habits & diet to include</span>
					</h2>
			...
			<div className="benefits-tabs">
				<div className="container">
					<h2>
						With Shape <span>eating smart has never been easier</span>
					</h2>
					...
					<div className="steps-intro-container">
						<div className="steps-content">
							...
							<ul className="steps-list">
								...
								<li>
									<h5>2. Collect</h5>
									<p>Review your plan to make sure everything looks good, swapping out anything you don't like. Then, use the grocery list to shop for your ingredients.</p>
								</li>
								<li>
									<h5>3. Cook</h5>
									<p>
